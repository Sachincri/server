...
export const updateSettings = asyncHandler(async (req: Request, res: Response) => {
    ...
    const updateData = {
        ...
        smtpHost: req.body.smtpHost !== undefined ? String(req.body.smtpHost) : undefined,
        smtpPort: req.body.smtpPort !== undefined ? Number(req.body.smtpPort) : undefined,
        smtpUser: req.body.smtpUser !== undefined ? String(req.body.smtpUser) : undefined,
        smtpPassword: req.body.smtpPassword !== undefined ? String(req.body.smtpPassword) : undefined,
        sendgridApiKey: req.body.sendgridApiKey !== undefined ? String(req.body.sendgridApiKey) : undefined,
...
export const getPublicSettings = asyncHandler(async (req: Request, res: Response) => {
    ...
    // Only return public fields if necessary, for now returning all
    res.status(200).json(ApiResponse.success({
        settings: {
            ...(settings as any).toObject(),
            stripePublishableKey: process.env.STRIPE_PUBLISHABLE_KEY || ""
